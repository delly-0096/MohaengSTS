...
public interface ITripRecordMapper {
	...
	int updateCoverAttachNo(@Param("rcdNo") long rcdNo, @Param("attachNo") Long attachNo);
	...
	int insertAttachFile(@Param("attachNo") long attachNo, @Param("regId") long regId);

	int insertAttachFileDetail(@Param("fileNo") long fileNo, @Param("attachNo") long attachNo,
			@Param("fileName") String fileName, @Param("originalName") String originalName, @Param("ext") String ext,
			@Param("size") long size, @Param("path") String path, @Param("fileGbCd") String fileGbCd,
			@Param("mimyType") String mimyType, @Param("useYn") String useYn, @Param("regId") long regId);
	...
	int insertTripRecordSeq(@Param("connNo") long connNo, @Param("rcdNo") long rcdNo, @Param("order") int order,
			@Param("blockType") String blockType, @Param("targetPk") String targetPk // ✅ String
	);

	long nextTourPlaceReviewSeq();

	int insertTourPlaceReview(@Param("placeReviewNo") long placeReviewNo, @Param("rcdConnNo") long rcdConnNo,
			@Param("memNo") long memNo, @Param("plcNo") Long plcNo, @Param("reviewConn") String reviewConn,
			@Param("rating") double rating);

	int insertTripRecordTxt(@Param("connNo") long connNo, @Param("text") String text);

	int insertTripRecordImg(@Param("connNo") long connNo, @Param("attachNo") Long attachNo, @Param("desc") String desc);
