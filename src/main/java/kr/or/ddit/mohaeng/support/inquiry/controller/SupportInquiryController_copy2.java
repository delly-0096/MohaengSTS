...
public class SupportInquiryController_copy2 {
	...
	public String inquiry(
		...
		System.out.println("loginObj type: " + (loginObj != null ? loginObj.getClass().getName() : "null"));
...
//			memNo = Integer.parseInt(String.valueOf(((Map<?, ?>) loginObj).get("MEM_NO")));
//		}

			Map<String, Object> params = new HashMap<>();
			params.put("memNo", "1");//누구 글인지
