				  ...
				  <div class="card mb-4">
				    <div class="card-body">
					  ...
					  <!-- 댓글 붙이기 --> 
						...
						<pre>
						boardVO 있음? ${not empty boardVO}
						commentList null? ${empty boardVO.commentList}
						commentList size: <c:out value="${empty boardVO.commentList ? 0 : fn:length(boardVO.commentList)}"/>
						</pre>
...
const api = (...parts) => {
	...
	form.action = api('api', 'talk', 'comments');
