                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" id="bookerPhone"
                                           value="${sessionScope.loginMember.phone}" placeholder="010-0000-0000" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group mb-0">
                                    ...
                                    <input type="email" class="form-control" id="bookerEmail"
                                           value="${sessionScope.loginMember.email}" required>
...
document.getElementById('bookingInfoForm').addEventListener('submit', function(e) {
    ...
    setTimeout(function() {
        ...
        setTimeout(function() {
            window.location.href = '${pageContext.request.contextPath}/tour/complete/1';
        }, 500);
    }, 1500);
});
</script>
